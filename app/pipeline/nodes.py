...
async def explanation_finalise(state: PipelineState) -> dict:
    ...
    try:
        ...
        # source of truth — see app.agents.explanation.compute_grounding). The
        # live graph uses THIS path; the helper keeps it byte-identical to the
        # legacy run_explanation_agent path. Failed-vendor notices are appended
        # below.
        from app.agents.explanation import compute_grounding, METHODOLOGY_NOTE
