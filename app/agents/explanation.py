...
async def run_explanation_agent(
    ...
    # grounding and must not be scored 0%. If no narrative made any PDF claim,
    # completeness is vacuously 1.0. The honesty rule stays fully strict on the
    # PDF claims that ARE made.
    claim_bearing = [
