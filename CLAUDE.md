...
**Next action:** **Open the E3 PR** (branch `e3-evidence-benchmark`), then pick up E3 follow-ups in priority order — **E3.a extraction recall ~0.60** (biggest quality lever), then E3.b contradiction→insufficient, E3.c missing-mandatory→reject. Also queued: E2 auth follow-ups (invite/reset email delivery via Phase 8 SMTP, rate-limit `/token` + `/password-reset/request`, schedule `purge_expired_sessions`), P2.23/P2.24, 8b wiring.
**Blockers:** none
