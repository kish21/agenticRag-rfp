...
**Next action (next session): pick one (recommend #215 if a collection-count trigger is near, else E3.f).** #215 (Qdrant per-org collection redesign — P2, ADR-001/bounded; trigger when collection count nears the limit), E3.f (#209, scanned/OCR — feature-request/P4), E3.g, E2 auth follow-ups, 8b. (E3.b.1 residual = #210, de-prioritised.)
